    <%@ attribute name="title" required="true" %>
        ...
        <c:if test="${activePage == 'listUser' or activePage == 'editUser' or activePage == 'menWorkout' or activePage == 'womenWorkout' or
                    activePage == 'start' or activePage == 'mAbs' or activePage == 'mArms' or activePage == 'mBack' or activePage == 'mLegs'
                    or activePage == 'wAbs' or activePage == 'wArms' or activePage == 'wBack' or activePage == 'wLegs'}">
